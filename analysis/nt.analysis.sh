...
grep p-value: ~/data/shchurch/SOWH/sowhat/test.output/nt.test1/sowhat.results.* >analysis/nt.test1.pvals
...
grep p-value: ~/data/shchurch/SOWH/sowhat/test.output/nt.test3/sowhat.results.* >analysis/nt.test3.pvals
...
grep p-value: ~/data/shchurch/SOWH/sowhat/test.output/nt.test4/sowhat.results.* >analysis/nt.test4.pvals
...
grep p-value: ~/data/shchurch/SOWH/sowhat/test.output/nt.test5/sowhat.results.* >analysis/nt.test5.pvals
