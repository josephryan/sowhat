...
perl sowhat --constraint=published_datasets/castoe.t1.tre --aln=published_datasets/castoe2009.phy --partition=published_datasets/castoe.parts.txt --model=GTRGAMMA --dir=/users/shchurch/scratch/castoe.test2.0 --name=castoe.test2.0 --rax=~/data/shchurch/SOWH/src/raxmlHPC --seqgen=~/data/shchurch/SOWH/src/Seq-Gen.v1.3.3/source/seq-gen >output.castoe.test2.0 --reps=500 --usepb

perl sowhat --constraint=published_datasets/castoe.t1.tre --aln=published_datasets/castoe2009.phy --model=GTRGAMMA --dir=/users/shchurch/scratch/castoe.test2.1 --name=castoe.test2.1 --rax=~/data/shchurch/SOWH/src/raxmlHPC --seqgen=~/data/shchurch/SOWH/src/Seq-Gen.v1.3.3/source/seq-gen >output.castoe.test2.1 --reps=100
